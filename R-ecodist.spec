...
Version  : 2.0.9
Release  : 41
URL      : https://cran.r-project.org/src/contrib/ecodist_2.0.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ecodist_2.0.9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651760108
